...
def animateMulti(frames,line1,line2,line3,line4,xdata,ydata1,ydata2,ydata3,ydata4,max,dRings):
	global state
	ProgressState.set(100*frames/max)
	if frames < 1000:
...
def plotGraphMulti(dRing,
	...
	anim = animation.FuncAnimation(fig, partial(animateMulti,line1=result1,line2=result2,line3=result3,line4=result4,xdata=wavelength,ydata1=gain1,ydata2=gain2,ydata3=gain3,ydata4=gain4,max=max,dRings=dRing), np.arange(0,4001,20), interval=1, repeat=False)
...
def funAnalysis():
	...
	plotGraphMulti(dRings,
		   ...
		   4000)
	setBars({'R1':0,'R2':0,'R3':0})
	setIndicators({'R1':0,'R2':0,'R3':0})
	ax.legend(loc='best', labelcolor=legendColor) #loc='upper right'
	canvas.draw_idle()
	pass
